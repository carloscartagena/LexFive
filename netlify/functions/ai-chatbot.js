export const handler = async (event, context) => {
  ...
  try {
    ...
    // Convert messages (if not strictly matching gemini API, though SDK matched it, let's pass it directly as it was {role, parts:[{text}]}
    ...
    if (callPart && callPart.functionCall.name === 'guardar_consulta') {
      functionCall = {
