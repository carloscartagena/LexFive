...
// ============================================================
import { ESTADOS, ABOGADOS } from '@/utils/config.js';
import { ICON } from '@/utils/icons.js';
import { esc, hoyISO, fmtDate, fmtDateTime, fmtHora } from '@/utils/util.js';
import { fmtMoneda } from '@/views/exportar.js';
import { $, content } from '@/utils/dom.js';
import { barChart, toast, hint, loading, openModal, closeModal } from '@/utils/ui.js';
import { state } from '@/utils/state.js';
import { profName, namesFromIds } from '@/shared/comunes.js';
import { supabase } from '@/api/supabase.js';
import { TAREA_PRIOR, tareaForm } from '@/views/tareas.js';
