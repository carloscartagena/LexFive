...
import { loading, toast } from '@/utils/ui.js';
import { state } from '@/utils/state.js';
import { subirImagenBranding } from '@/utils/storage.js';
import { abrirEditorImagen, redimensionarDataUrl } from '@/views/imagenes.js';
import { ImgDB, IMG, ensureImgCache, guardarImagen, borrarImagen, saveLogosCustom, saveSellosCustom, findCustomLogo, findCustomSello } from '@/utils/media.js';
import { BRAND_LOGOS, BRAND_SELLOS, BRAND_LOGO_DEFAULT, BRAND_SELLO_DEFAULT, brandHidden, brandLogosVisibles, brandSellosVisibles } from '@/shared/branding-catalogos.js';
import { pushBranding, pushGalerias, hydrateBranding, brandingHydrated, pickActiveLogo, pickActiveSello, brandLogoSrc, brandSelloSrc, nombreLogoArchivo, nombreSelloArchivo, applyLogo } from '@/shared/branding.js';
